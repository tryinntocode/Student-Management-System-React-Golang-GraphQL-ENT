...
type User struct {
	...
	// PhNo holds the value of the "ph_no" field.
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldName, user.FieldEmail, user.FieldDob, user.FieldPhNo, user.FieldDepartment, user.FieldSemester:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldPhNo:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field ph_no", values[i])
			} else if value.Valid {
				_m.PhNo = value.String
			}
...
func (_m *User) String() string {
	...
	builder.WriteString(_m.Dob)
	builder.WriteString(", ")
	builder.WriteString("ph_no=")
	builder.WriteString(_m.PhNo)
	builder.WriteString(", ")
	builder.WriteString("department=")
	builder.WriteString(_m.Department)
	builder.WriteString(", ")
	builder.WriteString("semester=")
	builder.WriteString(_m.Semester)
	builder.WriteByte(')')
