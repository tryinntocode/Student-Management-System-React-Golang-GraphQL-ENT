...
func (m *UserMutation) SetPhNo(s string) {
	m.ph_no = &s
}

// PhNo returns the value of the "ph_no" field in the mutation.
func (m *UserMutation) PhNo() (r string, exists bool) {
	v := m.ph_no
	if v == nil {
		return
	}
...
// OldPhNo returns the old "ph_no" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldPhNo(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldPhNo is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldPhNo requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldPhNo: %w", err)
	}
	return oldValue.PhNo, nil
}

// ResetPhNo resets all changes to the "ph_no" field.
func (m *UserMutation) ResetPhNo() {
	m.ph_no = nil
}
...
func (m *UserMutation) SetSemester(s string) {
	m.semester = &s
}

// Semester returns the value of the "semester" field in the mutation.
func (m *UserMutation) Semester() (r string, exists bool) {
	v := m.semester
	if v == nil {
		return
	}
...
// OldSemester returns the old "semester" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldSemester(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserMutation) ResetSemester() {
	m.semester = nil
}
...
func (m *UserMutation) Fields() []string {
	...
	if m.ph_no != nil {
		fields = append(fields, user.FieldPhNo)
	}
	if m.department != nil {
		fields = append(fields, user.FieldDepartment)
	}
	if m.semester != nil {
		fields = append(fields, user.FieldSemester)
	}
	return fields
}
