...
A full-stack **Student Management System** built with a **Go GraphQL API** on the backend and a **React** dashboard on the frontend — designed to create, search, update, and delete student records through a clean, modern UI.

![Go](https://img.shields.io/badge/Go-1.26-00ADD8?style=flat&logo=go&logoColor=white)
![GraphQL](https://img.shields.io/badge/GraphQL-gqlgen-E10098?style=flat&logo=graphql&logoColor=white)
![Ent](https://img.shields.io/badge/ORM-Ent-black?style=flat)
...
![Vite](https://img.shields.io/badge/Vite-Frontend%20Tooling-646CFF?style=flat&logo=vite&logoColor=white)
...
|---|---|
| Backend Language | Go |
| API Layer | [gqlgen](https://gqlgen.com/) (schema-first GraphQL) |
